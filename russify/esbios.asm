...
;RCgoff
;	org	0e367h
	org	0e385h		;смещение выставлено по анализу
				;перехода в прошивке реальной машины
;RCgoff end
...
k80:	cmp	al,0f1h			;shift не был нажат - перевод стр->загл
 	...
 	cmp	al,0d0h
 	jb	k81
 	cmp	al,0feh			;ошибка, должно быть 0efh! 
						;Однако эти символы все равно не ввести с клавы
 	ja	k81
 	sub	al,20h
 	jmp	k61
